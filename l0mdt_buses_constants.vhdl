...
constant SLC_COMMON_bcid_msb : natural := 41;
...
constant SLC_COMMON_charge_msb : natural := 29;
...
constant SLC_COMMON_ptthresh_msb : natural := 28;
...
constant SLC_COMMON_posphi_msb : natural := 24;
...
constant SLC_COMMON_poseta_msb : natural := 15;
...
constant SLC_COMMON_slcid_msb : natural := 1;
...
constant SLC_ENDCAP_nswseg_angdtheta_msb : natural := 79;
...
constant SLC_ENDCAP_nswseg_posphi_msb : natural := 74;
...
constant SLC_ENDCAP_nswseg_poseta_msb : natural := 66;
...
constant SLC_ENDCAP_seg_angdphi_msb : natural := 52;
...
constant SLC_ENDCAP_seg_angdtheta_msb : natural := 48;
...
constant SLC_BARREL_cointype_msb : natural := 83;
...
constant SLC_BARREL_rpc3_posz_msb : natural := 81;
...
constant SLC_BARREL_rpc2_posz_msb : natural := 71;
...
constant SLC_BARREL_rpc1_posz_msb : natural := 61;
...
constant SLC_BARREL_rpc0_posz_msb : natural := 51;
...
constant SLCPROC_CAND_destsl_msb : natural := 53;
...
constant SLCPROC_CAND_phimod_msb : natural := 51;
...
constant SLCPROC_CAND_vec_mdtid_msb : natural := 43;
...
constant CSM_pulsewidth_msb : natural := 31;
...
constant CSM_chanid_msb : natural := 4;
...
constant SLCPROC_SEG_vec_ang_msb : natural := 47;
...
constant SLCPROC_SEG_vec_pos_msb : natural := 37;
...
constant SLCPROC_SEG_vec_mdtid_msb : natural := 27;
...
constant SLCPROC_SEG_mdtseg_dest_msb : natural := 21;
...
constant SLCPROC_SEG_SLC_MUID_msb : natural := 19;
...
constant TUBEREMAP_mdt_tube_time_msb : natural := 73;
...
constant TUBEREMAP_mdt_tube_z_msb : natural := 52;
...
constant TUBEREMAP_mdt_tube_rho_msb : natural := 33;
...
constant TUBEREMAP_mdt_tube_num_msb : natural := 15;
...
constant TUBEREMAP_mdt_tube_layer_msb : natural := 5;
...
constant HE_LSF_mdt_radius_msb : natural := 38;
...
constant HE_LSF_mdt_localy_msb : natural := 29;
...
constant HE_LSF_mdt_localx_msb : natural := 15;
...
constant HE_LSF_data_valid_msb : natural := 1;
...
constant HE_LSF_mdt_valid_msb : natural := 0;
...
constant HE_CSF_data_valid_msb : natural := 1;
...
constant HE_CSF_mdt_valid_msb : natural := 0;
...
constant SF_segquality_msb : natural := 54;
...
constant SF_segangle_msb : natural := 53;
...
constant SF_segpos_msb : natural := 42;
...
constant SF_segvalid_msb : natural := 26;
...
constant PTCALC_ENDCAP_mtc_quality_msb : natural := 99;
...
constant PTCALC_ENDCAP_mtc_nsegments_msb : natural := 98;
...
constant PTCALC_ENDCAP_mtc_charge_msb : natural := 96;
...
constant PTCALC_ENDCAP_mtc_procflags_msb : natural := 95;
...
constant PTCALC_ENDCAP_mtc_pt_msb : natural := 91;
...
constant PTCALC_ENDCAP_mtc_ptthresh_msb : natural := 83;
...
constant PTCALC_BARREL_mtc_quality_msb : natural := 103;
...
constant PTCALC_BARREL_mtc_nsegments_msb : natural := 102;
...
constant PTCALC_BARREL_mtc_charge_msb : natural := 100;
...
constant PTCALC_BARREL_mtc_procflags_msb : natural := 99;
...
constant PTCALC_BARREL_mtc_pt_msb : natural := 95;
...
constant PTCALC_BARREL_mtc_ptthresh_msb : natural := 87;
