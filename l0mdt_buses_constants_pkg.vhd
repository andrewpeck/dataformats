...
package mdttp_constants_pkg is
  ...
  constant SLC_MUID_slcid_mult : real := 1;
  ...
  constant SLC_MUID_slid_mult : real := 1;
  ...
  constant SLC_MUID_bcid_mult : real := 0;
  ...
  constant SLC_COMMON_slcid_mult : real := 1;
  ...
  constant SLC_COMMON_tcsent_mult : real := 2;
  ...
  constant SLC_COMMON_posphi_mult : real := 0;
  ...
  constant SLC_COMMON_ptthresh_mult : real := 0;
  ...
  constant SLC_COMMON_charge_mult : real := 2;
  ...
  constant SLC_ENDCAP_seg_angdtheta_mult : real := 0;
  ...
  constant SLC_ENDCAP_seg_angdphi_mult : real := 0;
  ...
  constant SLC_ENDCAP_nswseg_poseta_mult : real := 9638;
  ...
  constant SLC_ENDCAP_nswseg_posphi_mult : real := 0;
  ...
  constant SLC_ENDCAP_nswseg_angdtheta_mult : real := 1;
  ...
  constant SLC_BARREL_rpc0_posz_mult : real := 0;
  ...
  constant SLC_BARREL_rpc1_posz_mult : real := 0;
  ...
  constant SLC_BARREL_rpc2_posz_mult : real := 0;
  ...
  constant SLC_BARREL_rpc3_posz_mult : real := 0;
  ...
  constant SLC_BARREL_cointype_mult : real := 1;
  ...
  constant SLCPROC_PIPELINE_COMMON_busy_mult : real := 0;
  ...
  constant SLCPROC_PIPELINE_COMMON_destsl_mult : real := 2;
  ...
  constant SLCPROC_PIPELINE_COMMON_phimod_mult : real := 0;
  ...
  constant SLCPROC_PIPELINE_COMMON_INN_vec_mdtid_mult : real := 1;
  ...
  constant SLCPROC_PIPELINE_COMMON_MID_vec_mdtid_mult : real := 1;
  ...
  constant SLCPROC_PIPELINE_COMMON_OUT_vec_mdtid_mult : real := 1;
  ...
  constant SLCPROC_PIPELINE_COMMON_EXT_vec_mdtid_mult : real := 1;
  ...
  constant TDC_chanid_mult : real := 1;
  ...
  constant TDC_edgemode_mult : real := 1;
  ...
  constant TDC_coarsetime_mult : real := 0;
  ...
  constant TDCFORMAT_fiberid_mult : real := 1;
  ...
  constant TDCFORMAT_elinkid_mult : real := 1;
  ...
  constant TDCFORMAT_datavalid_mult : real := 2;
  ...
  constant TDCFORMAT_stationid_mult : real := 1;
  ...
  constant SLCPROC_HESF_SLC_MUID_mult : real := 0;
  ...
  constant SLCPROC_HESF_mdtseg_dest_mult : real := 1;
  ...
  constant SLCPROC_HESF_vec_mdtid_mult : real := 1;
  ...
  constant SLCPROC_HESF_vec_pos_mult : real := 0;
  ...
  constant SLCPROC_HESF_vec_ang_mult : real := 1;
  ...
  constant HE_LSF_mdt_valid_mult : real := 2;
  ...
  constant HE_LSF_data_valid_mult : real := 2;
  ...
  constant HE_LSF_mdt_radius_mult : real := 34;
  ...
  constant SF_segvalid_mult : real := 2;
  ...
  constant SF_segangle_mult : real := 1;
  ...
  constant SF_segquality_mult : real := 2;
  ...
  constant PTCALC_mtc_ptthresh_mult : real := 0;
  ...
  constant PTCALC_mtc_charge_mult : real := 2;
  ...
  constant PTCALC_mtc_nsegments_mult : real := 1;
  ...
  constant PTCALC_mtc_quality_mult : real := 1;
  ...
  constant SLCPIPE_MTC_ENDCAP_SLC_MUID_mult : real := 0;
  ...
  constant MTC_mtc_procflags_mult : real := 1;
