...
const int SLC_MUID_BCID_DECB = SW_LEN - SW_IW;
const int SLC_MUID_BCID_IW = SW_IW;
...
const int SLC_MUID_SLID_DECB = SW_LEN - SW_IW;
const int SLC_MUID_SLID_IW = SW_IW;
const int SLC_MUID_SLID_SCALE = 1;
const float SLC_MUID_SLID_SCALE_INV = 1;
...
const int SLC_MUID_SLCID_DECB = SW_LEN - SW_IW;
const int SLC_MUID_SLCID_IW = SW_IW;
const int SLC_MUID_SLCID_SCALE = 1;
const float SLC_MUID_SLCID_SCALE_INV = 1;
...
const int SLC_COMMON_CHARGE_DECB = SW_LEN - SW_IW;
const int SLC_COMMON_CHARGE_IW = SW_IW;
const int SLC_COMMON_CHARGE_SCALE = 1;
const float SLC_COMMON_CHARGE_SCALE_INV = 1;
...
const int SLC_COMMON_PTTHRESH_DECB = SW_LEN - SW_IW;
const int SLC_COMMON_PTTHRESH_IW = SW_IW;
...
const int SLC_COMMON_POSPHI_DECB = SW_LEN - SW_IW;
const int SLC_COMMON_POSPHI_IW = SW_IW;
...
const float SLC_COMMON_POSETA_SCALE_INV = 1;
...
const int SLC_COMMON_TCSENT_DECB = SW_LEN - SW_IW;
const int SLC_COMMON_TCSENT_IW = SW_IW;
const int SLC_COMMON_TCSENT_SCALE = 1;
const float SLC_COMMON_TCSENT_SCALE_INV = 1;
...
const int SLC_COMMON_SLCID_DECB = SW_LEN - SW_IW;
const int SLC_COMMON_SLCID_IW = SW_IW;
const int SLC_COMMON_SLCID_SCALE = 1;
const float SLC_COMMON_SLCID_SCALE_INV = 1;
...
const int SLC_ENDCAP_NSWSEG_ANGDTHETA_DECB = SW_LEN - SW_IW;
const int SLC_ENDCAP_NSWSEG_ANGDTHETA_IW = SW_IW;
const int SLC_ENDCAP_NSWSEG_ANGDTHETA_SCALE = 1;
const float SLC_ENDCAP_NSWSEG_ANGDTHETA_SCALE_INV = 1;
...
const int SLC_ENDCAP_NSWSEG_POSPHI_DECB = SW_LEN - SW_IW;
const int SLC_ENDCAP_NSWSEG_POSPHI_IW = SW_IW;
...
const float SLC_ENDCAP_NSWSEG_POSETA_SCALE_INV = 1;
...
const int SLC_ENDCAP_SEG_ANGDPHI_DECB = SW_LEN - SW_IW;
const int SLC_ENDCAP_SEG_ANGDPHI_IW = SW_IW;
...
const int SLC_ENDCAP_SEG_ANGDTHETA_DECB = SW_LEN - SW_IW;
const int SLC_ENDCAP_SEG_ANGDTHETA_IW = SW_IW;
...
const int SLC_ENDCAP_SLC_COMMON_DECB = SW_LEN - SW_IW;
const int SLC_ENDCAP_SLC_COMMON_IW = SW_IW;
const int SLC_ENDCAP_SLC_COMMON_SCALE = 1;
const float SLC_ENDCAP_SLC_COMMON_SCALE_INV = 1;
...
const int SLC_BARREL_COINTYPE_DECB = SW_LEN - SW_IW;
const int SLC_BARREL_COINTYPE_IW = SW_IW;
const int SLC_BARREL_COINTYPE_SCALE = 1;
const float SLC_BARREL_COINTYPE_SCALE_INV = 1;
...
const int SLC_BARREL_RPC3_POSZ_DECB = SW_LEN - SW_IW;
const int SLC_BARREL_RPC3_POSZ_IW = SW_IW;
...
const int SLC_BARREL_RPC2_POSZ_DECB = SW_LEN - SW_IW;
const int SLC_BARREL_RPC2_POSZ_IW = SW_IW;
...
const int SLC_BARREL_RPC1_POSZ_DECB = SW_LEN - SW_IW;
const int SLC_BARREL_RPC1_POSZ_IW = SW_IW;
...
const int SLC_BARREL_RPC0_POSZ_DECB = SW_LEN - SW_IW;
const int SLC_BARREL_RPC0_POSZ_IW = SW_IW;
...
const int SLC_BARREL_SLC_COMMON_DECB = SW_LEN - SW_IW;
const int SLC_BARREL_SLC_COMMON_IW = SW_IW;
const int SLC_BARREL_SLC_COMMON_SCALE = 1;
const float SLC_BARREL_SLC_COMMON_SCALE_INV = 1;
...
const int SLCPROC_PIPE_COMMON_EXT_VEC_MDTID_LEN = SW_LEN;
const int SLCPROC_PIPE_COMMON_EXT_VEC_MDTID_LSB = 0;
const int SLCPROC_PIPE_COMMON_EXT_VEC_MDTID_MSB = SLCPROC_PIPE_COMMON_EXT_VEC_MDTID_LSB + SW_LEN-1;
const int SLCPROC_PIPE_COMMON_EXT_VEC_MDTID_DECB = SW_LEN - SW_IW;
const int SLCPROC_PIPE_COMMON_EXT_VEC_MDTID_IW = SW_IW;
const int SLCPROC_PIPE_COMMON_EXT_VEC_MDTID_SCALE = 1;
const float SLCPROC_PIPE_COMMON_EXT_VEC_MDTID_SCALE_INV = 1;

// SLc Outer Vector MDT chamber ID
const int SLCPROC_PIPE_COMMON_OUT_VEC_MDTID_LEN = SW_LEN;
const int SLCPROC_PIPE_COMMON_OUT_VEC_MDTID_LSB = SLCPROC_PIPE_COMMON_EXT_VEC_MDTID_MSB + 1;
const int SLCPROC_PIPE_COMMON_OUT_VEC_MDTID_MSB = SLCPROC_PIPE_COMMON_OUT_VEC_MDTID_LSB + SW_LEN-1;
const int SLCPROC_PIPE_COMMON_OUT_VEC_MDTID_DECB = SW_LEN - SW_IW;
const int SLCPROC_PIPE_COMMON_OUT_VEC_MDTID_IW = SW_IW;
const int SLCPROC_PIPE_COMMON_OUT_VEC_MDTID_SCALE = 1;
const float SLCPROC_PIPE_COMMON_OUT_VEC_MDTID_SCALE_INV = 1;

// SLc Middle Vector MDT chamber ID
const int SLCPROC_PIPE_COMMON_MID_VEC_MDTID_LEN = SW_LEN;
const int SLCPROC_PIPE_COMMON_MID_VEC_MDTID_LSB = SLCPROC_PIPE_COMMON_OUT_VEC_MDTID_MSB + 1;
const int SLCPROC_PIPE_COMMON_MID_VEC_MDTID_MSB = SLCPROC_PIPE_COMMON_MID_VEC_MDTID_LSB + SW_LEN-1;
const int SLCPROC_PIPE_COMMON_MID_VEC_MDTID_DECB = SW_LEN - SW_IW;
const int SLCPROC_PIPE_COMMON_MID_VEC_MDTID_IW = SW_IW;
const int SLCPROC_PIPE_COMMON_MID_VEC_MDTID_SCALE = 1;
const float SLCPROC_PIPE_COMMON_MID_VEC_MDTID_SCALE_INV = 1;

// SLc Inner Vector MDT chamber ID
const int SLCPROC_PIPE_COMMON_INN_VEC_MDTID_LEN = SW_LEN;
const int SLCPROC_PIPE_COMMON_INN_VEC_MDTID_LSB = SLCPROC_PIPE_COMMON_MID_VEC_MDTID_MSB + 1;
const int SLCPROC_PIPE_COMMON_INN_VEC_MDTID_MSB = SLCPROC_PIPE_COMMON_INN_VEC_MDTID_LSB + SW_LEN-1;
const int SLCPROC_PIPE_COMMON_INN_VEC_MDTID_DECB = SW_LEN - SW_IW;
const int SLCPROC_PIPE_COMMON_INN_VEC_MDTID_IW = SW_IW;
const int SLCPROC_PIPE_COMMON_INN_VEC_MDTID_SCALE = 1;
const float SLCPROC_PIPE_COMMON_INN_VEC_MDTID_SCALE_INV = 1;

// SLc phimod
const int SLCPROC_PIPE_COMMON_PHIMOD_LEN = SW_LEN;
const int SLCPROC_PIPE_COMMON_PHIMOD_LSB = SLCPROC_PIPE_COMMON_INN_VEC_MDTID_MSB + 1;
const int SLCPROC_PIPE_COMMON_PHIMOD_MSB = SLCPROC_PIPE_COMMON_PHIMOD_LSB + SW_LEN-1;
const int SLCPROC_PIPE_COMMON_PHIMOD_DECB = SW_LEN - SW_IW;
const int SLCPROC_PIPE_COMMON_PHIMOD_IW = SW_IW;
const int SLCPROC_PIPE_COMMON_PHIMOD_SCALE = 1;
const float SLCPROC_PIPE_COMMON_PHIMOD_SCALE_INV = 1;

// SLc board destination
const int SLCPROC_PIPE_COMMON_DESTSL_LEN = SW_LEN;
const int SLCPROC_PIPE_COMMON_DESTSL_LSB = SLCPROC_PIPE_COMMON_PHIMOD_MSB + 1;
const int SLCPROC_PIPE_COMMON_DESTSL_MSB = SLCPROC_PIPE_COMMON_DESTSL_LSB + SW_LEN-1;
const int SLCPROC_PIPE_COMMON_DESTSL_DECB = SW_LEN - SW_IW;
const int SLCPROC_PIPE_COMMON_DESTSL_IW = SW_IW;
const int SLCPROC_PIPE_COMMON_DESTSL_SCALE = 1;
const float SLCPROC_PIPE_COMMON_DESTSL_SCALE_INV = 1;

// SLc busy flag
const int SLCPROC_PIPE_COMMON_BUSY_LEN = SW_LEN;
const int SLCPROC_PIPE_COMMON_BUSY_LSB = SLCPROC_PIPE_COMMON_DESTSL_MSB + 1;
const int SLCPROC_PIPE_COMMON_BUSY_MSB = SLCPROC_PIPE_COMMON_BUSY_LSB + SW_LEN-1;
const int SLCPROC_PIPE_COMMON_BUSY_DECB = SW_LEN - SW_IW;
const int SLCPROC_PIPE_COMMON_BUSY_IW = SW_IW;
const int SLCPROC_PIPE_COMMON_BUSY_SCALE = 1;
const float SLCPROC_PIPE_COMMON_BUSY_SCALE_INV = 1;

const int SLCPROC_PIPE_COMMON_LEN = SLCPROC_PIPE_COMMON_BUSY_LEN
		+ SLCPROC_PIPE_COMMON_DESTSL_LEN
		+ SLCPROC_PIPE_COMMON_PHIMOD_LEN
		+ SLCPROC_PIPE_COMMON_INN_VEC_MDTID_LEN
		+ SLCPROC_PIPE_COMMON_MID_VEC_MDTID_LEN
		+ SLCPROC_PIPE_COMMON_OUT_VEC_MDTID_LEN
		+ SLCPROC_PIPE_COMMON_EXT_VEC_MDTID_LEN;

// -------------------------------------------------------------------

// (COPY - SLC_MUID)
const int SLCPROC_PIPE_ENDCAP_SLC_MUID_LEN = SLC_MUID_LEN;
const int SLCPROC_PIPE_ENDCAP_SLC_MUID_LSB = 0;
const int SLCPROC_PIPE_ENDCAP_SLC_MUID_MSB = SLCPROC_PIPE_ENDCAP_SLC_MUID_LSB + SLC_MUID_LEN-1;
const int SLCPROC_PIPE_ENDCAP_SLC_MUID_DECB = SW_LEN - SW_IW;
const int SLCPROC_PIPE_ENDCAP_SLC_MUID_IW = SW_IW;
const int SLCPROC_PIPE_ENDCAP_SLC_MUID_SCALE = 1;
const float SLCPROC_PIPE_ENDCAP_SLC_MUID_SCALE_INV = 1;

// (COPY - SLC_ENDCAP)
const int SLCPROC_PIPE_ENDCAP_SLC_ENDCAP_LEN = SLC_ENDCAP_LEN;
const int SLCPROC_PIPE_ENDCAP_SLC_ENDCAP_LSB = SLCPROC_PIPE_ENDCAP_SLC_MUID_MSB + 1;
const int SLCPROC_PIPE_ENDCAP_SLC_ENDCAP_MSB = SLCPROC_PIPE_ENDCAP_SLC_ENDCAP_LSB + SLC_ENDCAP_LEN-1;
const int SLCPROC_PIPE_ENDCAP_SLC_ENDCAP_DECB = SW_LEN - SW_IW;
const int SLCPROC_PIPE_ENDCAP_SLC_ENDCAP_IW = SW_IW;
const int SLCPROC_PIPE_ENDCAP_SLC_ENDCAP_SCALE = 1;
const float SLCPROC_PIPE_ENDCAP_SLC_ENDCAP_SCALE_INV = 1;

// (COPY - SLCPROC_PIPE_COMMON)
const int SLCPROC_PIPE_ENDCAP_SLCPROC_PIPE_COMMON_LEN = SLCPROC_PIPE_COMMON_LEN;
const int SLCPROC_PIPE_ENDCAP_SLCPROC_PIPE_COMMON_LSB = SLCPROC_PIPE_ENDCAP_SLC_ENDCAP_MSB + 1;
const int SLCPROC_PIPE_ENDCAP_SLCPROC_PIPE_COMMON_MSB = SLCPROC_PIPE_ENDCAP_SLCPROC_PIPE_COMMON_LSB + SLCPROC_PIPE_COMMON_LEN-1;
const int SLCPROC_PIPE_ENDCAP_SLCPROC_PIPE_COMMON_DECB = SW_LEN - SW_IW;
const int SLCPROC_PIPE_ENDCAP_SLCPROC_PIPE_COMMON_IW = SW_IW;
const int SLCPROC_PIPE_ENDCAP_SLCPROC_PIPE_COMMON_SCALE = 1;
const float SLCPROC_PIPE_ENDCAP_SLCPROC_PIPE_COMMON_SCALE_INV = 1;

const int SLCPROC_PIPE_ENDCAP_LEN = SLCPROC_PIPE_ENDCAP_SLCPROC_PIPE_COMMON_LEN
		+ SLCPROC_PIPE_ENDCAP_SLC_ENDCAP_LEN
		+ SLCPROC_PIPE_ENDCAP_SLC_MUID_LEN;

// -------------------------------------------------------------------

// (COPY - SLC_MUID)
const int SLCPROC_PIPE_BARREL_SLC_MUID_LEN = SLC_MUID_LEN;
const int SLCPROC_PIPE_BARREL_SLC_MUID_LSB = 0;
const int SLCPROC_PIPE_BARREL_SLC_MUID_MSB = SLCPROC_PIPE_BARREL_SLC_MUID_LSB + SLC_MUID_LEN-1;
const int SLCPROC_PIPE_BARREL_SLC_MUID_DECB = SW_LEN - SW_IW;
const int SLCPROC_PIPE_BARREL_SLC_MUID_IW = SW_IW;
const int SLCPROC_PIPE_BARREL_SLC_MUID_SCALE = 1;
const float SLCPROC_PIPE_BARREL_SLC_MUID_SCALE_INV = 1;

// (COPY - SLC_BARREL)
const int SLCPROC_PIPE_BARREL_SLC_BARREL_LEN = SLC_BARREL_LEN;
const int SLCPROC_PIPE_BARREL_SLC_BARREL_LSB = SLCPROC_PIPE_BARREL_SLC_MUID_MSB + 1;
const int SLCPROC_PIPE_BARREL_SLC_BARREL_MSB = SLCPROC_PIPE_BARREL_SLC_BARREL_LSB + SLC_BARREL_LEN-1;
const int SLCPROC_PIPE_BARREL_SLC_BARREL_DECB = SW_LEN - SW_IW;
const int SLCPROC_PIPE_BARREL_SLC_BARREL_IW = SW_IW;
const int SLCPROC_PIPE_BARREL_SLC_BARREL_SCALE = 1;
const float SLCPROC_PIPE_BARREL_SLC_BARREL_SCALE_INV = 1;

// (COPY - SLCPROC_PIPE_COMMON)
const int SLCPROC_PIPE_BARREL_SLCPROC_PIPE_COMMON_LEN = SLCPROC_PIPE_COMMON_LEN;
const int SLCPROC_PIPE_BARREL_SLCPROC_PIPE_COMMON_LSB = SLCPROC_PIPE_BARREL_SLC_BARREL_MSB + 1;
const int SLCPROC_PIPE_BARREL_SLCPROC_PIPE_COMMON_MSB = SLCPROC_PIPE_BARREL_SLCPROC_PIPE_COMMON_LSB + SLCPROC_PIPE_COMMON_LEN-1;
const int SLCPROC_PIPE_BARREL_SLCPROC_PIPE_COMMON_DECB = SW_LEN - SW_IW;
const int SLCPROC_PIPE_BARREL_SLCPROC_PIPE_COMMON_IW = SW_IW;
const int SLCPROC_PIPE_BARREL_SLCPROC_PIPE_COMMON_SCALE = 1;
const float SLCPROC_PIPE_BARREL_SLCPROC_PIPE_COMMON_SCALE_INV = 1;

const int SLCPROC_PIPE_BARREL_LEN = SLCPROC_PIPE_BARREL_SLCPROC_PIPE_COMMON_LEN
		+ SLCPROC_PIPE_BARREL_SLC_BARREL_LEN
		+ SLCPROC_PIPE_BARREL_SLC_MUID_LEN;
...
const float TDC_PULSEWIDTH_SCALE_INV = 1;
...
const float TDC_FINETIME_SCALE_INV = 1;
...
const int TDC_COARSETIME_DECB = SW_LEN - SW_IW;
const int TDC_COARSETIME_IW = SW_IW;
...
const int TDC_EDGEMODE_DECB = SW_LEN - SW_IW;
const int TDC_EDGEMODE_IW = SW_IW;
const int TDC_EDGEMODE_SCALE = 1;
const float TDC_EDGEMODE_SCALE_INV = 1;
...
const int TDC_CHANID_DECB = SW_LEN - SW_IW;
const int TDC_CHANID_IW = SW_IW;
const int TDC_CHANID_SCALE = 1;
const float TDC_CHANID_SCALE_INV = 1;
...
const int TDCPOLMUX_DATAVALID_DECB = SW_LEN - SW_IW;
const int TDCPOLMUX_DATAVALID_IW = SW_IW;
const int TDCPOLMUX_DATAVALID_SCALE = 1;
const float TDCPOLMUX_DATAVALID_SCALE_INV = 1;
...
const int TDCPOLMUX_ELINKID_DECB = SW_LEN - SW_IW;
const int TDCPOLMUX_ELINKID_IW = SW_IW;
const int TDCPOLMUX_ELINKID_SCALE = 1;
const float TDCPOLMUX_ELINKID_SCALE_INV = 1;
...
const int TDCPOLMUX_FIBERID_DECB = SW_LEN - SW_IW;
const int TDCPOLMUX_FIBERID_IW = SW_IW;
const int TDCPOLMUX_FIBERID_SCALE = 1;
const float TDCPOLMUX_FIBERID_SCALE_INV = 1;
...
const int TDCPOLMUX_TDC_DECB = SW_LEN - SW_IW;
const int TDCPOLMUX_TDC_IW = SW_IW;
const int TDCPOLMUX_TDC_SCALE = 1;
const float TDCPOLMUX_TDC_SCALE_INV = 1;
...
const int SLCPROC_HPS_SF_VEC_ANG_LEN = SW_LEN;
const int SLCPROC_HPS_SF_VEC_ANG_LSB = 0;
const int SLCPROC_HPS_SF_VEC_ANG_MSB = SLCPROC_HPS_SF_VEC_ANG_LSB + SW_LEN-1;
const int SLCPROC_HPS_SF_VEC_ANG_DECB = SW_LEN - SW_IW;
const int SLCPROC_HPS_SF_VEC_ANG_IW = SW_IW;
const int SLCPROC_HPS_SF_VEC_ANG_SCALE = 1;
const float SLCPROC_HPS_SF_VEC_ANG_SCALE_INV = 1;

// SLc inner vector rho position
const int SLCPROC_HPS_SF_VEC_POS_LEN = SW_LEN;
const int SLCPROC_HPS_SF_VEC_POS_LSB = SLCPROC_HPS_SF_VEC_ANG_MSB + 1;
const int SLCPROC_HPS_SF_VEC_POS_MSB = SLCPROC_HPS_SF_VEC_POS_LSB + SW_LEN-1;
const int SLCPROC_HPS_SF_VEC_POS_DECB = SW_LEN - SW_IW;
const int SLCPROC_HPS_SF_VEC_POS_IW = SW_IW;
const int SLCPROC_HPS_SF_VEC_POS_SCALE = 1;
const float SLCPROC_HPS_SF_VEC_POS_SCALE_INV = 1;

// SLc Inner Vector MDT chamber ID
const int SLCPROC_HPS_SF_VEC_MDTID_LEN = SW_LEN;
const int SLCPROC_HPS_SF_VEC_MDTID_LSB = SLCPROC_HPS_SF_VEC_POS_MSB + 1;
const int SLCPROC_HPS_SF_VEC_MDTID_MSB = SLCPROC_HPS_SF_VEC_MDTID_LSB + SW_LEN-1;
const int SLCPROC_HPS_SF_VEC_MDTID_DECB = SW_LEN - SW_IW;
const int SLCPROC_HPS_SF_VEC_MDTID_IW = SW_IW;
const int SLCPROC_HPS_SF_VEC_MDTID_SCALE = 1;
const float SLCPROC_HPS_SF_VEC_MDTID_SCALE_INV = 1;

// inner MDT segment chip destination
const int SLCPROC_HPS_SF_MDTSEG_DEST_LEN = SW_LEN;
const int SLCPROC_HPS_SF_MDTSEG_DEST_LSB = SLCPROC_HPS_SF_VEC_MDTID_MSB + 1;
const int SLCPROC_HPS_SF_MDTSEG_DEST_MSB = SLCPROC_HPS_SF_MDTSEG_DEST_LSB + SW_LEN-1;
const int SLCPROC_HPS_SF_MDTSEG_DEST_DECB = SW_LEN - SW_IW;
const int SLCPROC_HPS_SF_MDTSEG_DEST_IW = SW_IW;
const int SLCPROC_HPS_SF_MDTSEG_DEST_SCALE = 1;
const float SLCPROC_HPS_SF_MDTSEG_DEST_SCALE_INV = 1;

// SLc Muon Unique Identifier
const int SLCPROC_HPS_SF_SLC_MUID_LEN = SLC_MUID_LEN;
const int SLCPROC_HPS_SF_SLC_MUID_LSB = SLCPROC_HPS_SF_MDTSEG_DEST_MSB + 1;
const int SLCPROC_HPS_SF_SLC_MUID_MSB = SLCPROC_HPS_SF_SLC_MUID_LSB + SLC_MUID_LEN-1;
const int SLCPROC_HPS_SF_SLC_MUID_DECB = SW_LEN - SW_IW;
const int SLCPROC_HPS_SF_SLC_MUID_IW = SW_IW;
const int SLCPROC_HPS_SF_SLC_MUID_SCALE = 1;
const float SLCPROC_HPS_SF_SLC_MUID_SCALE_INV = 1;

// SLC Valid bit
const int SLCPROC_HPS_SF_SLC_VALID_LEN = SW_LEN;
const int SLCPROC_HPS_SF_SLC_VALID_LSB = SLCPROC_HPS_SF_SLC_MUID_MSB + 1;
const int SLCPROC_HPS_SF_SLC_VALID_MSB = SLCPROC_HPS_SF_SLC_VALID_LSB + SW_LEN-1;
const int SLCPROC_HPS_SF_SLC_VALID_DECB = SW_LEN - SW_IW;
const int SLCPROC_HPS_SF_SLC_VALID_IW = SW_IW;
const int SLCPROC_HPS_SF_SLC_VALID_SCALE = 1;
const float SLCPROC_HPS_SF_SLC_VALID_SCALE_INV = 1;

const int SLCPROC_HPS_SF_LEN = SLCPROC_HPS_SF_SLC_VALID_LEN
		+ SLCPROC_HPS_SF_SLC_MUID_LEN
		+ SLCPROC_HPS_SF_MDTSEG_DEST_LEN
		+ SLCPROC_HPS_SF_VEC_MDTID_LEN
		+ SLCPROC_HPS_SF_VEC_POS_LEN
		+ SLCPROC_HPS_SF_VEC_ANG_LEN;
...
const float TAR_MDT_TUBE_TIME_SCALE_INV = 1;
...
const float TAR_MDT_TUBE_Z_SCALE_INV = 1;
...
const float TAR_MDT_TUBE_RHO_SCALE_INV = 1;
...
const int TAR_MDT_TUBE_NUM_DECB = SW_LEN - SW_IW;
const int TAR_MDT_TUBE_NUM_IW = SW_IW;
const int TAR_MDT_TUBE_NUM_SCALE = 1;
const float TAR_MDT_TUBE_NUM_SCALE_INV = 1;
...
const int TAR_MDT_TUBE_LAYER_DECB = SW_LEN - SW_IW;
const int TAR_MDT_TUBE_LAYER_IW = SW_IW;
const int TAR_MDT_TUBE_LAYER_SCALE = 1;
const float TAR_MDT_TUBE_LAYER_SCALE_INV = 1;
...
const float HPS_LSF_MDT_RADIUS_SCALE_INV = 1;
...
const float HPS_LSF_MDT_LOCALY_SCALE_INV = 1;
...
const float HPS_LSF_MDT_LOCALX_SCALE_INV = 1;
...
const int HPS_LSF_DATA_VALID_DECB = SW_LEN - SW_IW;
const int HPS_LSF_DATA_VALID_IW = SW_IW;
const int HPS_LSF_DATA_VALID_SCALE = 1;
const float HPS_LSF_DATA_VALID_SCALE_INV = 1;
...
const float HPS_CSF_MDT_RADIUS_SCALE_INV = 1;
...
const float HPS_CSF_MDT_LOCALY_SCALE_INV = 1;
...
const float HPS_CSF_MDT_LOCALX_SCALE_INV = 1;
...
const int HPS_CSF_DATA_VALID_DECB = SW_LEN - SW_IW;
const int HPS_CSF_DATA_VALID_IW = SW_IW;
const int HPS_CSF_DATA_VALID_SCALE = 1;
const float HPS_CSF_DATA_VALID_SCALE_INV = 1;
...
const int SLCPIPE_PTCALC_CHARGE_DECB = SW_LEN - SW_IW;
const int SLCPIPE_PTCALC_CHARGE_IW = SW_IW;
const int SLCPIPE_PTCALC_CHARGE_SCALE = 1;
const float SLCPIPE_PTCALC_CHARGE_SCALE_INV = 1;
...
const int SLCPIPE_PTCALC_PHIMOD_DECB = SW_LEN - SW_IW;
const int SLCPIPE_PTCALC_PHIMOD_IW = SW_IW;
...
const int SLCPIPE_PTCALC_SLC_MUID_DECB = SW_LEN - SW_IW;
const int SLCPIPE_PTCALC_SLC_MUID_IW = SW_IW;
const int SLCPIPE_PTCALC_SLC_MUID_SCALE = 1;
const float SLCPIPE_PTCALC_SLC_MUID_SCALE_INV = 1;
...
const int SF_SEGQUALITY_DECB = SW_LEN - SW_IW;
const int SF_SEGQUALITY_IW = SW_IW;
const int SF_SEGQUALITY_SCALE = 1;
const float SF_SEGQUALITY_SCALE_INV = 1;
...
const int SF_SEGANGLE_DECB = SW_LEN - SW_IW;
const int SF_SEGANGLE_IW = SW_IW;
const int SF_SEGANGLE_SCALE = 1;
const float SF_SEGANGLE_SCALE_INV = 1;
...
const float SF_SEGPOS_SCALE_INV = 1;
...
const int SF_SEGVALID_DECB = SW_LEN - SW_IW;
const int SF_SEGVALID_IW = SW_IW;
const int SF_SEGVALID_SCALE = 1;
const float SF_SEGVALID_SCALE_INV = 1;
...
const int SF_VEC_MDTID_DECB = SW_LEN - SW_IW;
const int SF_VEC_MDTID_IW = SW_IW;
const int SF_VEC_MDTID_SCALE = 1;
const float SF_VEC_MDTID_SCALE_INV = 1;
...
const int SF_SLC_MUID_DECB = SW_LEN - SW_IW;
const int SF_SLC_MUID_IW = SW_IW;
const int SF_SLC_MUID_SCALE = 1;
const float SF_SLC_MUID_SCALE_INV = 1;
...
const int PTCALC_QUALITY_DECB = SW_LEN - SW_IW;
const int PTCALC_QUALITY_IW = SW_IW;
const int PTCALC_QUALITY_SCALE = 1;
const float PTCALC_QUALITY_SCALE_INV = 1;
...
const int PTCALC_NSEGMENTS_DECB = SW_LEN - SW_IW;
const int PTCALC_NSEGMENTS_IW = SW_IW;
const int PTCALC_NSEGMENTS_SCALE = 1;
const float PTCALC_NSEGMENTS_SCALE_INV = 1;
...
const int PTCALC_CHARGE_DECB = SW_LEN - SW_IW;
const int PTCALC_CHARGE_IW = SW_IW;
const int PTCALC_CHARGE_SCALE = 1;
const float PTCALC_CHARGE_SCALE_INV = 1;
...
const int PTCALC_PTTHRESH_DECB = SW_LEN - SW_IW;
const int PTCALC_PTTHRESH_IW = SW_IW;
...
const float PTCALC_PT_SCALE_INV = 1;
...
const float PTCALC_ETA_SCALE_INV = 1;
...
const int PTCALC_SLC_MUID_DECB = SW_LEN - SW_IW;
const int PTCALC_SLC_MUID_IW = SW_IW;
const int PTCALC_SLC_MUID_SCALE = 1;
const float PTCALC_SLC_MUID_SCALE_INV = 1;
...
const int SLCPIPE_MTC_ENDCAP_DESTSL_DECB = SW_LEN - SW_IW;
const int SLCPIPE_MTC_ENDCAP_DESTSL_IW = SW_IW;
const int SLCPIPE_MTC_ENDCAP_DESTSL_SCALE = 1;
const float SLCPIPE_MTC_ENDCAP_DESTSL_SCALE_INV = 1;
...
const int SLCPIPE_MTC_ENDCAP_BUSY_DECB = SW_LEN - SW_IW;
const int SLCPIPE_MTC_ENDCAP_BUSY_IW = SW_IW;
const int SLCPIPE_MTC_ENDCAP_BUSY_SCALE = 1;
const float SLCPIPE_MTC_ENDCAP_BUSY_SCALE_INV = 1;
...
const int SLCPIPE_MTC_ENDCAP_SLC_COMMON_DECB = SW_LEN - SW_IW;
const int SLCPIPE_MTC_ENDCAP_SLC_COMMON_IW = SW_IW;
const int SLCPIPE_MTC_ENDCAP_SLC_COMMON_SCALE = 1;
const float SLCPIPE_MTC_ENDCAP_SLC_COMMON_SCALE_INV = 1;
...
const int SLCPIPE_MTC_ENDCAP_SLC_MUID_DECB = SW_LEN - SW_IW;
const int SLCPIPE_MTC_ENDCAP_SLC_MUID_IW = SW_IW;
const int SLCPIPE_MTC_ENDCAP_SLC_MUID_SCALE = 1;
const float SLCPIPE_MTC_ENDCAP_SLC_MUID_SCALE_INV = 1;
...
const int SLCPIPE_MTC_BARREL_DESTSL_DECB = SW_LEN - SW_IW;
const int SLCPIPE_MTC_BARREL_DESTSL_IW = SW_IW;
const int SLCPIPE_MTC_BARREL_DESTSL_SCALE = 1;
const float SLCPIPE_MTC_BARREL_DESTSL_SCALE_INV = 1;
...
const int SLCPIPE_MTC_BARREL_BUSY_DECB = SW_LEN - SW_IW;
const int SLCPIPE_MTC_BARREL_BUSY_IW = SW_IW;
const int SLCPIPE_MTC_BARREL_BUSY_SCALE = 1;
const float SLCPIPE_MTC_BARREL_BUSY_SCALE_INV = 1;
...
const int SLCPIPE_MTC_BARREL_SLC_COMMON_DECB = SW_LEN - SW_IW;
const int SLCPIPE_MTC_BARREL_SLC_COMMON_IW = SW_IW;
const int SLCPIPE_MTC_BARREL_SLC_COMMON_SCALE = 1;
const float SLCPIPE_MTC_BARREL_SLC_COMMON_SCALE_INV = 1;
...
const int SLCPIPE_MTC_BARREL_SLC_MUID_DECB = SW_LEN - SW_IW;
const int SLCPIPE_MTC_BARREL_SLC_MUID_IW = SW_IW;
const int SLCPIPE_MTC_BARREL_SLC_MUID_SCALE = 1;
const float SLCPIPE_MTC_BARREL_SLC_MUID_SCALE_INV = 1;
...
const int SLCPIPE_MTC_BARREL_COINTYPE_DECB = SW_LEN - SW_IW;
const int SLCPIPE_MTC_BARREL_COINTYPE_IW = SW_IW;
const int SLCPIPE_MTC_BARREL_COINTYPE_SCALE = 1;
const float SLCPIPE_MTC_BARREL_COINTYPE_SCALE_INV = 1;
...
const int MTC_QUALITY_DECB = SW_LEN - SW_IW;
const int MTC_QUALITY_IW = SW_IW;
const int MTC_QUALITY_SCALE = 1;
const float MTC_QUALITY_SCALE_INV = 1;
...
const int MTC_NSEGMENTS_DECB = SW_LEN - SW_IW;
const int MTC_NSEGMENTS_IW = SW_IW;
const int MTC_NSEGMENTS_SCALE = 1;
const float MTC_NSEGMENTS_SCALE_INV = 1;
...
const int MTC_PROCFLAGS_DECB = SW_LEN - SW_IW;
const int MTC_PROCFLAGS_IW = SW_IW;
const int MTC_PROCFLAGS_SCALE = 1;
const float MTC_PROCFLAGS_SCALE_INV = 1;
...
const int MTC_CHARGE_DECB = SW_LEN - SW_IW;
const int MTC_CHARGE_IW = SW_IW;
const int MTC_CHARGE_SCALE = 1;
const float MTC_CHARGE_SCALE_INV = 1;
...
const int MTC_PTTHRESH_DECB = SW_LEN - SW_IW;
const int MTC_PTTHRESH_IW = SW_IW;
...
const float MTC_PT_SCALE_INV = 1;
...
const float MTC_ETA_SCALE_INV = 1;
...
const int MTC_SLC_COMMON_DECB = SW_LEN - SW_IW;
const int MTC_SLC_COMMON_IW = SW_IW;
const int MTC_SLC_COMMON_SCALE = 1;
const float MTC_SLC_COMMON_SCALE_INV = 1;
