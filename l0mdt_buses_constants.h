...
const int SLCPROC_HPS_SLC_MUIDSLC_MUID_MSB = 47;
const int SLCPROC_HPS_SLC_MUIDSLC_MUID_LSB = 28;
const int SLCPROC_HPS_SLC_MUIDSLC_MUID_DECB = 0;

// inner MDT segment chip destination
const int SLCPROC_HPS_MDTSEG_DESTMDTSEG_DEST_LEN = 2;
const int SLCPROC_HPS_MDTSEG_DESTMDTSEG_DEST_MSB = 27;
const int SLCPROC_HPS_MDTSEG_DESTMDTSEG_DEST_LSB = 26;
const int SLCPROC_HPS_MDTSEG_DESTMDTSEG_DEST_DECB = 0;

// SLc Inner Vector MDT chamber ID
const int SLCPROC_HPS_VEC_MDTIDVEC_MDTID_LEN = 6;
const int SLCPROC_HPS_VEC_MDTIDVEC_MDTID_MSB = 25;
const int SLCPROC_HPS_VEC_MDTIDVEC_MDTID_LSB = 20;
const int SLCPROC_HPS_VEC_MDTIDVEC_MDTID_DECB = 0;

// SLc inner vector rho position
const int SLCPROC_HPS_VEC_POSVEC_POS_LEN = 10;
const int SLCPROC_HPS_VEC_POSVEC_POS_MSB = 19;
const int SLCPROC_HPS_VEC_POSVEC_POS_LSB = 10;
const int SLCPROC_HPS_VEC_POSVEC_POS_DECB = 0;

// SLc inner vector theta angle
const int SLCPROC_HPS_VEC_ANGVEC_ANG_LEN = 10;
const int SLCPROC_HPS_VEC_ANGVEC_ANG_MSB = 9;
const int SLCPROC_HPS_VEC_ANGVEC_ANG_LSB = 0;
