...
const int HESF_IN_SLCPROC_SLC_MUID_IN_HESF_width = 20;
const int HESF_IN_SLCPROC_SLC_MUID_IN_HESF_lsb = 28;
const int HESF_IN_SLCPROC_SLC_MUID_IN_HESF_msb = 47;
