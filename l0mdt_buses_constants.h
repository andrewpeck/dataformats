...
const int TDCPOLMUX_FIBERIDFIBERID_MSB = 9;
const int TDCPOLMUX_FIBERIDFIBERID_LSB = 5;
const int TDCPOLMUX_FIBERIDFIBERID_DECB = 0;

// Elink ID within fiber
const int TDCPOLMUX_ELINKIDELINKID_LEN = 4;
const int TDCPOLMUX_ELINKIDELINKID_MSB = 4;
const int TDCPOLMUX_ELINKIDELINKID_LSB = 1;
const int TDCPOLMUX_ELINKIDELINKID_DECB = 0;

// Valid bit
const int TDCPOLMUX_DATAVALIDDATAVALID_LEN = 1;
const int TDCPOLMUX_DATAVALIDDATAVALID_MSB = 0;
const int TDCPOLMUX_DATAVALIDDATAVALID_LSB = 0;
...
const int SLCPROC_HPS_SF_SLC_MUIDSLC_MUID_LEN = 20;
const int SLCPROC_HPS_SF_SLC_MUIDSLC_MUID_MSB = 47;
const int SLCPROC_HPS_SF_SLC_MUIDSLC_MUID_LSB = 28;
const int SLCPROC_HPS_SF_SLC_MUIDSLC_MUID_DECB = 0;

// inner MDT segment chip destination
const int SLCPROC_HPS_SF_MDTSEG_DESTMDTSEG_DEST_LEN = 2;
const int SLCPROC_HPS_SF_MDTSEG_DESTMDTSEG_DEST_MSB = 27;
const int SLCPROC_HPS_SF_MDTSEG_DESTMDTSEG_DEST_LSB = 26;
const int SLCPROC_HPS_SF_MDTSEG_DESTMDTSEG_DEST_DECB = 0;

// SLc Inner Vector MDT chamber ID
const int SLCPROC_HPS_SF_VEC_MDTIDVEC_MDTID_LEN = 6;
const int SLCPROC_HPS_SF_VEC_MDTIDVEC_MDTID_MSB = 25;
const int SLCPROC_HPS_SF_VEC_MDTIDVEC_MDTID_LSB = 20;
const int SLCPROC_HPS_SF_VEC_MDTIDVEC_MDTID_DECB = 0;

// SLc inner vector rho position
const int SLCPROC_HPS_SF_VEC_POSVEC_POS_LEN = 10;
const int SLCPROC_HPS_SF_VEC_POSVEC_POS_MSB = 19;
const int SLCPROC_HPS_SF_VEC_POSVEC_POS_LSB = 10;
const int SLCPROC_HPS_SF_VEC_POSVEC_POS_DECB = 0;

// SLc inner vector theta angle
const int SLCPROC_HPS_SF_VEC_ANGVEC_ANG_LEN = 10;
const int SLCPROC_HPS_SF_VEC_ANGVEC_ANG_MSB = 9;
const int SLCPROC_HPS_SF_VEC_ANGVEC_ANG_LSB = 0;
const int SLCPROC_HPS_SF_VEC_ANGVEC_ANG_DECB = 0;
...
const int TAR_MDT_TUBE_TIMEMDT_TUBE_TIME_LEN = 18;
const int TAR_MDT_TUBE_TIMEMDT_TUBE_TIME_MSB = 17;
const int TAR_MDT_TUBE_TIMEMDT_TUBE_TIME_LSB = 0;
